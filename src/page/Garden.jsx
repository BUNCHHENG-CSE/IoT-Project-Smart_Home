  ...
  return (
    <Layout>
      <div className="bg-inherit dark:bg-inherit h-full w-[85%] overflow-y-scroll right-0 sm:pr-3 mx-5">
        <div className="h-[18%] w-full grid lg:grid-cols-1 gap-6 md:grid-cols-1 sm:grid-col-1 sm:mt-10 sm:ml-2">
          <div
            className={`self-center mb-7 h-[12rem] w-[50%] sm:w-[92%]  sm:mt-10 sm:h-max px-10 py-7 rounded-3xl mt-4 shadow-2xl shadow-zinc-800  dark:shadow-zinc-700  transition-all duration-300 ease hover:shadow-none bg-[#30fffa]`}
          >
          ...
          <div
            className=" col-span-1 h-[12rem] sm:h-max w-[50%] sm:w-[92%] px-10 py-7 rounded-3xl mt-4 shadow-lg shadow-zinc-800  dark:shadow-zinc-700  transition-all duration-300 ease hover:shadow-none border border-opacity-0  border-stone-950 hover:border-opacity-100 dark:border-white dark:border-opacity-0 dark:hover:border-opacity-100"
            onClick={() =>
              setWaterPumbToggle(
