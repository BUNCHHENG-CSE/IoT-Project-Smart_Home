...
const ControlLedFirstFloor = ({ publish, payload }) => {
  ...
  const [kledToggle, setKLedToggle] = useState("OFF1");

  const [be1ledToggle, setBe1LedToggle] = useState("OFF2");
  const [ba1ledToggle, setBa1LedToggle] = useState("OFF3");
  const [gledToggle, setGLedToggle] = useState("OFF4");
  ...
  //         setBe2LedToggle(tempDataValue[0]);
  //         setTempDataValue("");
  //       } else if (tempDataValue === "ON4" || tempDataValue === "OFF4") {
  //         setBa1LedToggle(tempDataValue[0]);
  //         setTempDataValue("");
  //       } else if (tempDataValue === "ON5" || tempDataValue === "OFF5") {
  //         setBa2LedToggle(tempDataValue[0]);
  //         setTempDataValue("");
  //       } else if (tempDataValue === "ON6" || tempDataValue === "OFF6") {
  //         setSLedToggle(tempDataValue[0]);
  //         setTempDataValue("");
  //       }
  //     }
...
export default ControlLedFirstFloor;
