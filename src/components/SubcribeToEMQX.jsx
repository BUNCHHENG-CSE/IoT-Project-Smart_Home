    ...
    <Layout>
      ...
      >
        ...
        <div className="flex justify-between">
          <button
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold text-[1.1rem] rounded-lg text-sm w-full sm:w-auto lg:w-fit px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
