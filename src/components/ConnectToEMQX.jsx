...
const ConnectToEMQX = ({ connect, disconnect, connectBtn }) => {
  ...
  return (
    <Layout>
      <form
        className=" h-max w-[60%] px-10 py-7 rounded-3xl mt-4 shadow-lg shadow-zinc-800  dark:shadow-zinc-700  transition-all duration-300 ease hover:shadow-none border border-opacity-0  border-stone-950 hover:border-opacity-100 dark:border-white dark:border-opacity-0 dark:hover:border-opacity-100"
        action=""
      >
