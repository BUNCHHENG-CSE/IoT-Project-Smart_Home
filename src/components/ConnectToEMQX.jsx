    ...
    <Layout>
      ...
      >
        ...
        <div className="flex justify-between md:gap-2">
          ...
          <button
            className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg font-semibold  sm:text-[0.9rem] sm:w-[45%] text-[1.1rem] w-[40%] px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
